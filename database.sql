...
('مركز لوقا الطبي',          'مركز طبي', 'متخصص',   '١٠ رمسيس العباسية القاهرة ١١٥٦٦',                 '02-26812345',  80, 4.6, 30.0750, 31.2686, 'luka-medical.com'),
('مستشفى شبرا العام',        'مستشفى',   'عام',     'شبرا - ٤٠ شارع الترعة القاهرة ١١٦٤٣',             '02-24367890', 400, 4.1, 30.0861, 31.2434, ''),
('مستشفى الدمرداش التعليمي', 'مستشفى',   'عام',     'المطرية - ٢٥ شارع الدمرداش القاهرة ١١٧٥٧',        '02-26055255', 800, 4.3, 30.0889, 31.2922, 'demerdash.edu.eg'),
...
('مستشفى السلام الدولي',     'مستشفى',   'عام',     '٢٥ شارع عدلي مصر الجديدة القاهرة ١٣٤١',           '02-24155555', 250, 4.6, 30.0384, 31.3159, 'alsalamhospital.com'),
('مستشفى الدفاع الجوي',      'مستشفى',   'عام',     'مدينة نصر - ١٠٠ شارع ستار الخير القاهرة ١١٧٧١',   '02-24051234', 300, 4.2, 30.0600, 31.3100, '');
